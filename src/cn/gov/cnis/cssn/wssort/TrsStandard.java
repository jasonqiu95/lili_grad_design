...
public class TrsStandard
	...
	private String pagenum;   // ASTM页码
	private String filename;   // 电子文档名
	private String C001;   //通讯标示
	private String C005; //文件名
	private String C006; //功能
	private String language;  //语言
	private int C004;     //文件大小
	private String updateType; //更新类型
	private String C002;         //分类
	private Date updateTime;   //更新时间
	private Float C003;   //单价
