 ...
 *
 */
public abstract class AbstractDrmProductStandard
...
{ 
    ...
    private Long elec_id;//标准电子表ID
    private Long P_A001;//题录t_product_standard的a001
    
    private String standardState;//标注状态
    private String versionNum;//版本号
    private Float francPrice;//法郎价格
	...
	public Float getFrancPrice() {
		return francPrice;
	}


	public void setFrancPrice(Float francPrice) {
	...
	public AbstractDrmProductStandard(Long id) {
		super();
		this.id = id;
	}
	...
	public AbstractDrmProductStandard() {
		super();
	}
	...
	public Long getP_A001() {
		return P_A001;
	}


	public void setP_A001(Long p_a001) {
		P_A001 = p_a001;
	}
