...
<body>
       <div class="header-top">
			<div class="wrap">
			  <div class="cssmenu">
				<ul>
					<li class="active"><a href="logining.htm">管理员登录</a></li> |     
<!-- 					<li><a href="logining.htm">登录</a></li> -->
<!-- 					 | -->

					 <c:choose> 
	          			  <c:when test="${user==null }"><li><a href="logining.htm">用户登录</a></li></c:when> 
	           		   <c:when test="${user!=null }"><li><a>${user.account  } &nbsp; 欢迎您使用文献服务</a></li>|<li><a href="unlogin.htm"> 注销</a></li></c:when> 
	 ...
	 <div class="header-bottom">
	    <div class="wrap">
			<div class="header-bottom-left">
				<div class="logo">
					<a href="#"><img height="75" width="400"  src="images/logo.png" alt=""/></a>
				</div>
				<div class="menu"></div>
		</div>
	   <div class="header-bottom-right" >
         <form  action="${pageContext.request.contextPath }/search.htm" method="get" name="formSearch1" >
         <div class="search" > 
	  ...
	  <div class="tag-list">
	    <ul class="icon1 sub-icon1 profile_img">
			<li><a class="active-icon c1" > </a>
				<ul class="sub-icon1 list">
					<li><h3>欢迎使用文献检索服务</h3><a href=""></a></li>
	    ...
	    <ul class="last"><li><a>文献信息检索</a></li></ul>
	  </div>
    </div>
     <div class="clear"></div>
     </div>
            ...
            <div class="slide"> 
                ...
                <div class="slide_content">
                    <div class="slide_content_wrap">
                        <!-- Text title -->
                        <h4 class="title">欢迎来到标准文献检索中心</h4>
                        <!-- /Text title -->
...
<!--                        <p class="description">标准文献</p>-->
            ...
            <div class="slide">
                ...
                <div class="slide_content">
                    <div class="slide_content_wrap">
                        <h4 class="title">欢迎来到标准文献检索中心</h4>
<!--                        <p class="description">欢迎来到标准文献定制平台</p>
-->                    </div>
                </div>
            </div>
            <!--/slide -->
