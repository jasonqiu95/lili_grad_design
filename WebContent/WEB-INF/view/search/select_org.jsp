...
<div class="modal-header">
	...
	<h5>
		<a id="select_org" href="#interClass" mylink="/search/select_org.jsp">全部2</a> &nbsp; &nbsp; 
		<a id="select_org" href="#interClass" mylink="/search/select_org.jsp?domain=D_NATIVE">国内</a> &nbsp; 
		<a id="select_org" href="#interClass" mylink="/search/select_org.jsp?domain=D_NATIVE&stype=ST_N_SBTS">国内-国家</a> &nbsp; 
		<a id="select_org" href="#interClass" mylink="/search/select_org.jsp?domain=D_NATIVE&stype=ST_N_DB">国内-地方</a> &nbsp; 
		<a id="select_org" href="#interClass" mylink="/search/select_org.jsp?domain=D_NATIVE&stype=ST_N_CSIC">国内-行业</a> &nbsp; &nbsp; <!--br/>&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;-->
		<a id="select_org" href="#interClass" mylink="/search/select_org.jsp?domain=D_FOREIGN">国外</a> &nbsp; 
		<a id="select_org" href="#interClass" mylink="/search/select_org.jsp?domain=D_FOREIGN&stype=ST_F_INTER">国外-国际</a> &nbsp; 
		<a id="select_org" href="#interClass" mylink="/search/select_org.jsp?domain=D_FOREIGN&stype=ST_F_NATIONAL">国外-国家</a> &nbsp; 
		<a id="select_org" href="#interClass" mylink="/search/select_org.jsp?domain=D_FOREIGN&stype=ST_F_INSTITUTE">国外-学协会</a>
	</h5>
</div>
</form>
...
if (rs != null){
	...
	while(i<length){
		...
		icode = rs[i].getId();
		System.out.println("idcode:"+icode);
