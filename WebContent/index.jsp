          ...
          <ul class="collapse navbar-collapse nav navbar-nav top-menu">
                <li>
                    <form class="navbar-search pull-left" action="${pageContext.request.contextPath }/search/base.htm">
                        <input placeholder="标准资源检索" class="search-query form-control col-sm-7" name="keyword" id="keyword"
                               type="text">
                    </form>
                </li>
            </ul>
...
<iframe src="indexbuttom.jsp" id="auto" onload="autoHeight()" width="100%" frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="no" allowtransparency="yes"></iframe>
