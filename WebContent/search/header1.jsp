 ...
 <!-- topbar starts -->
    <div class="navbar navbar-default" role="navigation">
        ...
        <div class="navbar-inner">
            ...
            <a class="navbar-brand" href="index.htm"  target="_parent"> <!-- <img alt="Charisma Logo" src="img/logo20.png" class="hidden-xs"/> -->
          ...
          <ul class="collapse navbar-collapse nav navbar-nav top-menu">
            ...
            <div class="btn-group pull-right">
                ...
                <% if(u!=null){%>
                    <li><a href="logining.htm?from=change"  target="_parent">更改用户</a></li>
                    <li class="divider"></li>
                    <li><a href="unlogin.htm"  target="_parent">注销</a></li>
                     <% }
		            	else
						{
		                %>
		                 <li><a href="logo.htm"  target="_parent">上传logo</a></li>
                    <li class="divider"></li>
                    <li><a href="unloginadmin.htm"  target="_parent">管理员注销</a></li>
                    <%} %>
                </ul>
            </div>
             <%;}else{ %>
                ...
                <ul class="dropdown-menu">
                    <li><a href="logining.htm?from=admin"  target="_parent">管理员登录</a></li>
                    <li class="divider"></li>
                    <li><a href="logining.htm?from=login"  target="_parent">普通用户登录</a></li>
                </ul>
            </div>
                    <%;} %>
            <!-- user dropdown ends -->
