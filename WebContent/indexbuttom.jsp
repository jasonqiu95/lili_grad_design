	 ...
	 <div class="header-bottom">
	    <div class="wrap">
			<div class="header-bottom-left">
				<div class="logo">
					<a href="index.jsp" target="_parent"><img height="70" width="400"  src="images/logo.png" alt=""/></a>
				</div>
				<div class="menu"></div>
			</div>
	   <div class="header-bottom-right" >
         <form  action="${pageContext.request.contextPath }/search/base.htm" method="get" name="formSearch1" target="_parent">
         
         <div class="search" > 
				<input style="width: 150px;height: 35px;" type="text"  class="input-xlarge" id="keyword" name="keyword" value="搜索" onFocus="this.value = '文献';" onBlur="if (this.value == ' ') {this.value = '文献';}">
	  ...
	  <div class="tag-list">
	    ...
	    <ul class="last"><li><a href="${pageContext.request.contextPath }/search/search_base.jsp" target="_parent">更多检索服务</a></li></ul>
	    <ul class="last"><li><a href="${pageContext.request.contextPath }/mystandard/track.htm" target="_parent">标准跟踪</a></li></ul>
	  </div>
    </div>
     <div class="clear"></div>
     </div>
