...
QName opAddEntry = WebServiceClientConn.getTheMethod("getQuoteORQuotedStandard");
...
<dl>
	<%
	if(type.equalsIgnoreCase("A502"))
	{
	%>
	<dt class="cite01">引用了如下标准</dt>
	<%} else{%>
	<dt class="cite01">被如下标准引用</dt>
	<%
	}
	if(wrap.length>0)
	{
